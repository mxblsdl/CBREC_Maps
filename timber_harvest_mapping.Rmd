...
Data is structured in a list format only showing the time series emissions. I need to filter based on the Use first and then reference. The net emissions for each category are shown in the name of the list. \#TODO filter by reference as well.
...
# check layers
```{r}
st_layers("Q/input/harvests.gpkg")
```
